package com.example.attendeasecampuscompanion
    ...
    class FriendsListImplementation : ComponentActivity() {
        ...
        fun main(){
            val currentStudentId = "1311807"
            addFriendByStudentId(currentStudentId) { ok, err ->
                if (ok) Log.d("Friends", "Added $currentStudentId")
            }
        }
                    ...
                    db.collection(USERS)
                        ...
                        .addOnSuccessListener { snap ->
                            ...
                            if (completed == chunks.size)
                                onResult(results.sortedBy { it.name ?: it.studentId }, failed)
                        }
                        .addOnFailureListener { e ->
