    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = FriendAdapter(
            ...
            onSwitchToggle = { friend, isOn ->
                Toast.makeText(this, "$friend switch: $isOn", Toast.LENGTH_SHORT).show()
            },
            onButtonClick = { friend ->
                Toast.makeText(this, "Button clicked for $friend", Toast.LENGTH_SHORT).show()
            }
        )
        ...
        db.collection("Users").document(currentUserId)
            ...
            .addOnSuccessListener { result ->
                ...
                for (document in result) {
                    ...
                    friendsArray.add("$firstName $lastName")
                }
